...
class StaticTransform : TransformBase, Versionable {
    ...
    override val position = ObservablePoint(this);

    override val scale = ObservablePoint(this, 1f, 1f);

    override val pivot = ObservablePoint(this);

    override val skew = ObservablePoint(this);
